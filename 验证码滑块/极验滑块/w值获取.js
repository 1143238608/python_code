...
Object.defineProperties(Navigator.prototype, {
  userAgent: { get() { v_console_log("  [*] Navigator -> userAgent[get]", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"); return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" } },
...
Object.defineProperties(DOMRectReadOnly.prototype, {
  ...
  left: { get() { v_console_log("  [*] DOMRectReadOnly -> left[get]", 1188.21875); return 1188.21875 } },
  top: { get() { v_console_log("  [*] DOMRectReadOnly -> top[get]", 301.875); return 301.875 } },
...
Object.defineProperties(Element.prototype, {
  ...
  id: { get() { v_console_log("  [*] Element -> id[get]", "wait"); return "wait" } },
  className: { get() { v_console_log("  [*] Element -> className[get]", "geetest_holder geetest_douyufullpage"); return "geetest_holder geetest_douyufullpage" }, set() { v_console_log("  [*] Element -> className[set]", [].slice.call(arguments)); return "geetest_holder geetest_douyufullpage" } },
...
Object.defineProperties(HTMLElement.prototype, {
  ...
  offsetWidth: { get() { v_console_log("  [*] HTMLElement -> offsetWidth[get]", 3); return 3 } },
...
!function () {
    ...
    (_tkts.$_Ch(33) != typeof window ? window : this, function (window, t) {
        ...
        E = (/msie 7\.0/i[$_CJFP(164)](ht[$_CJEq(103)]),
            h[$_CJEq(295)]),
        C = (parseFloat(ht[$_CJFP(103)][$_CJFP(195)](ht[$_CJEq(103)][$_CJEq(137)]($_CJEq(267)) + 8)),
            parseFloat(ht[$_CJFP(103)][$_CJFP(195)](ht[$_CJFP(103)][$_CJEq(137)]($_CJEq(267)) + 8)) < 4.4),
        ...
        window.gettrack = W[$_CJEq(269)]["\u0024\u005f\u0046\u0044\u004c"];
		window.get_final = W[$_CJEq(269)]["\u0024\u005f\u0042\u0042\u0045\u0049"];
		Z[$_CJEq(269)] = {
            "\u0024\u005f\u0048\u0041\u0052": function (t) {
...
function get_u() {
    ...
    return new window.mxy()['encrypt'](get_random());
}

function get_l() {
    var o = {
        "lang": "zh-cn",
        "userresponse": "eb999ebbe9eb0ff0641",
        "passtime": 238,
        "imgload": 98,
        "aa": "O(!!DssHssssvutsztsyzuss(!!(f/M99119D:09120291,9",
        "ep": {
            "v": "7.9.0",
            "$_BIo": false,
            "me": true,
        ...
        "h9s9": "1816378497",
        "rp": "df9f656b1819f2ee249c13a6245af8ac"
    };
    return window.zhiyuan['encrypt'](window.gt_['stringify'](o), get_random());
}

function get_h(){
	return window.get_m["\u0024\u005f\u0046\u0045\u0045"](get_l());
}

function get_w(){
    console.log(get_h()+get_u());
        return get_h()+get_u();
}
//[[-25,-31,0],[0,0,0],[0,1,38],[1,1,54],[4,1,62],[7,1,70],[11,1,78],[15,1,86],[18,1,94],[22,1,102],[25,1,110],[28,1,118],[31,1,126],[33,1,134],[35,1,141],[36,1,158],[37,1,165],[38,1,302],[39,1,310],[41,1,326],[43,1,342],[45,0,350],[46,0,358],[47,0,374],[48,0,382],[49,0,390],[50,0,398],[51,0,406],[52,-1,414],[52,-1,518]]
function get_aa(xxxx){
	return window.get_final(window.gettrack(xxxx),[12,58,98,36,43,95,62,15,12],"4c4b3177");
	//第二个参数固定，第三个参数从网页请求中获取
}
get_w()